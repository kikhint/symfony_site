 ...
 */
final class Version20240504185813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 1, '10 user included')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 1, '2 GB of storage')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 1, 'Email support')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 1, 'Help center access')");

        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 2, '20 user included')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 2, '10 GB of storage')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 2, 'Priority email support')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 2, 'Help center access')");

        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 3, '30 user included')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 3, '15 GB of storage')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 3, 'Phone and email support')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_id_seq'), 3, 'Help center access')");
